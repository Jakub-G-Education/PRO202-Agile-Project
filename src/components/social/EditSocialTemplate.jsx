...
const EditSocialTemplate = ({ selectedEventId, setSelectedEventId }) => {
  const { getById, editEvent, deleteEvent, getEventsFromService } =
  ...
  const getByIdFromContext = async () => {
    const eventFromContext = await getById(selectedEventId);

    if (eventFromContext) {
      setEventToUpdate(eventFromContext);
      setSelected(new Date(eventFromContext.date));
    }
  };
...
export default EditSocialTemplate;
